...
## Plot the structure of gene "gene-stambpl1" in file "gff3_sample_5000.gff3" after re-calculating the position.
dir <- system.file("extdata", package="GeneStructurePlot")
...
##Read the information of gene "stambpl1"  from file "gene_structure_table_stambpl1.txt".
dir <- system.file("extdata", package="GeneStructurePlot")
gene_info<-gene_structure_table_read(file.path(dir,"gene_structure_table_stambpl1.txt"))
plot_gene_structure_table (gene_info)
...
## Plot the structure of gene "gene-LOC101070858" in file "gff3_sample_5000.gff3".
dir <- system.file("extdata", package="GeneStructurePlot")
